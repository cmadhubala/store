  ...
  <body >
    ...
    <div class="jumbotron"style="background-color:#0000ff;">
      <div class="container" style="background-color:#0000ff;">
        ...
        <p class="lead">“What I say is, a town isn’t a town without a bookstore. It may call itself a town, but unless it’s got a bookstore, it knows it’s not foolin’ a soul.”!</p>
      </div>
    </div>
    <?php } ?>
